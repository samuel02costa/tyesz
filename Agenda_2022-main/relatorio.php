              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="editar.php?idUp=<?php echo $show->id_contato;?>" title="Editar" class="btn btn-success" ><img  src="svg/editar.png" style="width:25px;"></a>
                    <a href="deletar.php?idDel=<?php echo $show->id_contato;?>" onclick="return confirm('Desejar remover esse contato ?')" 
                    title="Remover" class="btn btn-danger" style="margin-left:10px"><img style="width: 25px;" src="svg/remover.png"></a>
                  </td>
                  </tr>
                  <?php
                      }
